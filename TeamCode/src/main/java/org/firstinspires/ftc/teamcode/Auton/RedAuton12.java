...
public class RedAuton12 extends OpMode {
    ...
    public void buildPaths(){
        ...
        Path7 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(88, 60), new Pose(135, 60))
                )
                .setTangentHeadingInterpolation()
                .setTimeoutConstraint(intakeTimeout)
                .build();
        ...
        Path10 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(88, 37), new Pose(135, 37))
                )
                .setTangentHeadingInterpolation()
                .setTimeoutConstraint(intakeTimeout)
                .build();
            ...
            case INTAKE2ALIGN_INTAKE2POSE:
                if (!follower.isBusy()) {
                    if (ShooterDone1) {
                        ...
                        if (!follower.isBusy() | (follower.getPose().getX()) > 134) {
    ...
    public void loop() {
        ...
        telemetry.addData("lever timer", LeverTimer.seconds());
